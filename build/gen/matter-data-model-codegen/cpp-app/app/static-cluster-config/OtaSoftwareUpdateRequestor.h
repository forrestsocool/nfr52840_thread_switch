...
//
// Application configuration for OtaSoftwareUpdateRequestor based on EMBER
// configuration from
...
inline constexpr AttributeId kEndpoint0EnabledAttributes[] = {
    ...
    Attributes::ClusterRevision::Id,     Attributes::DefaultOTAProviders::Id,
    Attributes::FeatureMap::Id,          Attributes::GeneratedCommandList::Id,
    Attributes::UpdatePossible::Id,      Attributes::UpdateState::Id,
