...
//
// Application configuration for AdministratorCommissioning based on EMBER
// configuration from
...
inline constexpr AttributeId kEndpoint0EnabledAttributes[] = {
    Attributes::AcceptedCommandList::Id,  Attributes::AdminFabricIndex::Id,
    Attributes::AdminVendorId::Id,        Attributes::AttributeList::Id,
    ...
    kFixedClusterConfig = {{
        {
            ...
            .enabledCommands =
                Span<const CommandId>(detail::kEndpoint0EnabledCommands),
        },
    }};
