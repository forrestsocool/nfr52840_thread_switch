...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STATE_LEDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ENABLE_ICD_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_DEFAULT_TX_POWER, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ENABLE_READ_CLIENT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_LAST_FABRIC_REMOVED_ERASE_AND_REBOOT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_LAST_FABRIC_REMOVED_ACTION_DELAY, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_MALLOC_SYS_HEAP_SIZE, 10240);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_WORK_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COMMON_LIBC_MALLOC_ARENA_SIZE, -1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOOKUP_CACHE_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DYNAMIC_INTERRUPTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DYNAMIC_DIRECT_INTERRUPTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_DYNAMIC_INTERRUPTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 36);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 36);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_TIMEOUT, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GAP_AUTO_UPDATE_CONN_PARAMS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_PARAM_UPDATE_TIMEOUT, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT_EXTRA, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 251);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ICD_SLOW_POLL_INTERVAL, 2500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ICD_SIT_SLOW_POLL_LIMIT, 15000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ICD_FAST_POLLING_INTERVAL, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ICD_IDLE_MODE_DURATION, 120);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ICD_ACTIVE_MODE_THRESHOLD, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_ENABLE_HEAP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_HEAP_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_CRYPTO_PSA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CRYPTO_DRIVER_OBERON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ALG_SHA_224, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PSA_KEY_SLOT_COUNT, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_APP_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_DEFAULT_LEVEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_LOG_SIZE_OPTIMIZATION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_MINIMAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_CMD_BUFF_SIZE, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_APP_TASK_QUEUE_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_APP_TASK_MAX_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_LEDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_TEST_EVENT_TRIGGERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_TEST_EVENT_TRIGGERS_MAX, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_TEST_EVENT_TRIGGERS_REGISTER_DEFAULTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_TEST_EVENT_TRIGGERS_MAX_TRIGGERS_DELEGATES, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_TEST_SHELL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MATTER_ZAP_FILE_PATH, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_NUM_MESSAGE_BUFFERS, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOOKUP_CACHE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOOKUP_CACHE_FOR_SETTINGS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WIFI_PROV_CORE_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_HAS_PAKE_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ALG_SPAKE2P_MATTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ALG_ECB_NO_PADDING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_GENERATE_RANDOM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_KEY_TYPE_SPAKE2P_KEY_PAIR_BASIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_KEY_TYPE_SPAKE2P_KEY_PAIR_IMPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_KEY_TYPE_SPAKE2P_PUBLIC_KEY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_SPAKE2P_MATTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_SPAKE2P, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_PAKE_DRIVER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TRUSTED_STORAGE_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TRUSTED_STORAGE_BACKEND_AEAD_KEY_HASH_UID, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WFA_QT_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DK_LIBRARY_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_SYS_INIT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_NETDIAG_VENDOR_INFO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF5_DELAY_TRX_ACC, 20);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_NORDIC_LIBRARY_COMMON, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_VENDOR_ID, 65521);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_VENDOR_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_PRODUCT_ID, 32772);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_PRODUCT_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_HARDWARE_VERSION, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_HARDWARE_VERSION_STRING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_MANUFACTURING_DATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SERIAL_NUMBER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_ROTATING_DEVICE_UID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_TYPE, 65535);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_DISCRIMINATOR, 0xF00);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SPAKE2_PASSCODE, 20202021);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SPAKE2_IT, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SPAKE2_SALT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SPAKE2_TEST_VERIFIER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_ENABLE_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_PRODUCT_FINISH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_PRODUCT_COLOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ENABLE_PAIRING_AUTOSTART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OPERATIONAL_TIME_SAVE_INTERVAL, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_PERSISTENT_SUBSCRIPTIONS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_LIB_SHELL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_PROJECT_CONFIG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ENABLE_DNSSD_SRP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ENABLE_DNS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_ICD_ACTIVE_MODE_DURATION, 300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OPENTHREAD_CONFIG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_FACTORY_RESET_ERASE_SETTINGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_MALLOC_SYS_HEAP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_MALLOC_SYS_HEAP_OVERRIDE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MATTER_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MATTER_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_LINK_WITH_CHIP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_BLE_EXT_ADVERTISING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_BLE_ADVERTISING_DURATION, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_NRF_PLATFORM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_BOOTLOADER_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_EXAMPLE_DEVICE_INFO_PROVIDER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEBUG_SYMBOLS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_LOG_FILE_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_TASK_STACK_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_FACTORY_DATA_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_MAX_FABRICS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_MAX_ACTIVE_CASE_CLIENTS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_MAX_ACTIVE_DEVICES, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_SUBSCRIPTION_RESUMPTION_MIN_RETRY_INTERVAL, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_SUBSCRIPTION_RESUMPTION_RETRY_MULTIPLIER, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_USE_OPENTHREAD_ENDPOINT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_SYSTEM_PACKETBUFFER_POOL_SIZE, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PROMICRO_NRF52840, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PROMICRO_NRF52840_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPU_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENTROPY_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HWINFO_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UDC_DRIVER_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_USBD_COMMON_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBC_LOG_LEVEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_VIRTIO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_VIRTIO_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_BUF_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XSI_SINGLE_PROCESS_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRC_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_DEVICE_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SETTINGS_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_LOG_LEVEL, 1);
